				...
				<div class="col-md-6 col-sm-6 create-new-account">
					...
					<form class="register-form outer-top-xs" action="?act=taikhoan&xuli=dangky" method="post" role="form" id="form2">
						...
						<div class="form-group">
							...
							<input type="text" name="SDT" class="form-control unicase-form-control text-input" id="exampleInputEmail1">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" name="DiaChi" class="form-control unicase-form-control text-input" id="exampleInputEmail1">
						</div>
						<div class="form-group">
